...
* 🔍 **[auditoria-red-diagnostico-dns](https://github.com/GonzaloGaBa/auditoria-red-diagnostico-dns/tree/master)**: Auditoría de red, verificación de tablas de enrutamiento OSPF, inspección de caché ARP, trazado de rutas y resolución de incidentes DNS en Cisco Packet Tracer.
...
* 📶 **[wireshark-telnet-ssh-analysis](https://github.com/GonzaloGaBa/wireshark-telnet-ssh-analysis/tree/master)**: Análisis forense de tráfico de red en Wireshark: comparación de exposición de credenciales en texto plano (Telnet) frente a la robustez del cifrado extremo a extremo (SSH).
